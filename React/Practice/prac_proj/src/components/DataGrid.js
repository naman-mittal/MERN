...
export default function DataGrid(props) {
  ...
  useEffect(() => {
    ...
    const id = '6092bbe362f32a34c8f40291'
          ...
          <Paper className={classes.paper}>
            ...
            <List className={classes.list}>
              ...
              <DataItem
                ...
                title="Email"
                value={user.empEmailId ? user.empEmailId : '---'}
              ></DataItem>
              <DataItem
          ...
          <Paper className={classes.paper}>
            ...
            <List className={classes.list}>
              <DataItem
                icon={<FaceIcon />}
                title="Username"
                value={user.loginDetails.userName ? user.loginDetails.userName : '---'}
              ></DataItem>
              <DataItem
                icon={<SecurityIcon />}
                title="Authorization"
                value={user.loginDetails.roles[0].name ? 'role' : '---'}
              ></DataItem>
            </List>
          </Paper>
        </Grid> */}
